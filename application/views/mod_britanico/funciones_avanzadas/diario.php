...
<script>
    $.getScript('./application/views/mod_britanico/funciones_avanzadas/diario.js', function() {
    });
...
<div class="container-full marco p-1">
    ...
    <div class="form-row">
        <div class="browser_controls" style="padding-right:5px;display:inline;">
         ...
         <div class="form-row">
            ...
            <div class="col-md-8">
                ...
                <input id="DESTINO_I" type="radio" name="DESTINO" value="I" checked>
                &nbsp;&nbsp;
        ...
        <div class="form-row">
            ...
            <div class="col-md-8">
                <label for="LBL-Totalizado" style="font-weight:bold;">Modo</label>
                &nbsp;&nbsp;
                <label for="MODO_N"> Normal </label>
                <input id="MODO_N" type="radio" name="MODO" value="N" checked>
                &nbsp;&nbsp;
                <label for="MODO_T">Totalizado</label>
                <input id="MODO_T" type="radio" name="MODO" value="T" >
            </div>
