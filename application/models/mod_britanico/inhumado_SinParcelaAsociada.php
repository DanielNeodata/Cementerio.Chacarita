...
class inhumado_SinParcelaAsociada extends MY_Model {
    ...
    public function brow($values){
        try {
            ...
            $where = "id_parcela_actual is null";
            ...
            $values["filters"]=array(
                ...
                array("name"=>"browser_search", "operator"=>"like","fields"=>array("id_inhumado","nombre")),                
            );  
    ...
    public function historicoInhumado_CEM($values) {
        // Este es el metodo que se invoca desde JS, el boton de Historico de Inhumado.
        try {
	        
            $sqlHistorico = "SELECT * FROM dbo.vw_MovimientoInhumado WHERE id_inhumado=? ORDER BY FechaMovimiento;";
            $prms=array("id_inhumado1" => $values["id_inhumado"]);            
    ...
    public function BorrarMI_CEM($values){
        try {
            ...
            $prms=array("NumeroMovimiento" => $values["NumeroMovimiento"]);            
            $rc = $this->execAdHocWithParms($sqlHistorico, $prms);
